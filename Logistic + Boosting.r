...
#BOOSTING
library("gbm")
gbm1<-gbm(y_train~x[,1]+x[,2]+x[,3], data=x, n.trees=1000,shrinkage=0.1,bag.fraction = 0.5,train.fraction = 0.8)
plot(gbm1)
names(gbm1)
...
par(mfrow=c(2,2))
plot(t,main="Hill Climbing",col="red",pch=20,xlab="Cases",ylab="TP + TN")
